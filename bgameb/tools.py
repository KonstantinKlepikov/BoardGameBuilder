...
# class Shaker(BaseToolExtended[K, GenDice]):
#     """Shaker object
...
class Shaker(BaseToolExtended[Dice]):
    ...
    def deal(
        ...
        Args:
            components (Component): game components
            items (Optional[List[str]]): items ids
...
# class Deck(BaseToolExtended[K, GenCard], Generic[K, GenCard]):
#     """Deck object
